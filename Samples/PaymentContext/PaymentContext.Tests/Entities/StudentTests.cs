...
{    
    ...
    public class SudentTests
    {
        ...
        public SudentTests()
        {
            ...
            _document = new Document("11823168833", EDocumentType.CPF);
        ...
        [TestMethod]
        public void Should_Return_Error_WhenHad_ActiveSubscription()
        {
        ...
        [TestMethod]
        public void Should_Return_Error_When_SubscriptionHas_NoPayment()
        {
            _student.AddSubscription(_subscription);
            Assert.IsTrue(_student.Invalid);
        }
