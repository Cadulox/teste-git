using System;
using System.Linq;
using LinqLambdaExample.Entities;
...
namespace LinqLambdaExample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Usar só quando tiver certeza que vai retornar apenas 1 elemento ou nenhum
            Console.WriteLine("Sinlge or default test1: " + r8);

            var r9 = products.Where(p => p.Id == 30).SingleOrDefault();            
            Console.WriteLine("Sinlge or default test2: " + r9);
            Console.WriteLine();
